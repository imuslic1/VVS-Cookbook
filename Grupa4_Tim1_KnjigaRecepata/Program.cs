    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int ispisMenija(string tipKnjige) {
                ...
                Console.WriteLine("3. Ispis shopping liste za odabrani recept");
                ...
                Console.WriteLine("7. Pretraga recepata po ocjeni");
                Console.WriteLine("8. Ispiši trenutnu knjigu recepata");
                Console.WriteLine("9. Ispiši trenutnu knjigu recepata sortiranu prema vremenu pripreme");
                Console.WriteLine("10. Ispiši trenutnu knjigu recepata sortiranu prema kompleksnosti");
            ...
            void drugiMeni(int drugaOpcija, int indeksTrenutneKnjige) {
                switch (drugaOpcija)
                {
                    ...
                    case 3:
                        Console.WriteLine("Unesite naziv recepta: ");
                        Boolean korektanNaziv3 = false;
                        Recept trazeniRecept1 = null;
                        while (!korektanNaziv3)
                        {
                            try
                            {
                                naziv = Convert.ToString(Console.ReadLine());
                                trazeniRecept1 = kr.pretraziKnjiguRecepata(knjigeRecepata[indeksTrenutneKnjige], naziv);
                                korektanNaziv3 = true;
